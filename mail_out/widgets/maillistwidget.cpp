...
MaillistWidget::MaillistWidget(QWidget *parent, QSqlDatabase db) : QWidget(parent)
{
...
void MaillistWidget::getDialog()
{

}

void MaillistWidget::dell()
{
    QMessageBox msgBox;
...
void MaillistWidget::setId(int id)
{
